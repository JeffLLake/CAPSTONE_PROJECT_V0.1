'This is the checkout page. The user will use this page to enter their personal details/ card info and send it to a database.
Public Class CHECKOUT_PAGE
    'File location that the text file is located
    ...
    End Sub
    'this button returns you to the product page
    Private Sub Return_to_Product_Page_button_Click(sender As Object, e As EventArgs) Handles Return_to_Product_Page_button.Click
        ...
        zone.ShowDialog()
    End Sub
    'This button writes all of the information to a text file
